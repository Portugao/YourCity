 ...
 * between location and branch entities.
 */
class AbstractLocationBranchRepository extends EntityRepository
{
    /**
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('\\MU\\YourCityModule\\Entity\\LocationBranch', 'tbl');
        $query = $qb->getQuery();
        $query->execute();

        $logArgs = ['app' => 'MUYourCityModule', 'entity' => 'location branch'];
