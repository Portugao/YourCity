...
abstract class AbstractServiceOfLocationRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\YourCityModule\Entity\ServiceOfLocationEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUYourCityModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'services of location', 'userid' => $userId];
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('serviceOfLocation', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numServicesOfLocation';
        if (true === $useJoins) {
