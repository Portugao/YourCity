 ...
 * between part of menu and dish entities.
 */
class AbstractPartOfMenuDishRepository extends EntityRepository
{
    /**
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('\\MU\\YourCityModule\\Entity\\PartOfMenuDish', 'tbl');
        $query = $qb->getQuery();
        $query->execute();

        $logArgs = ['app' => 'MUYourCityModule', 'entity' => 'part of menu dish'];
