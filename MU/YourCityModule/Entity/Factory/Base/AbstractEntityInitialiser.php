...
abstract class AbstractEntityInitialiser
{
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('location', 'partOfCity');
        $items = [];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('offer', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('menuOfLocation', 'kindOfMenu');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
        ...
        $listEntries = $this->listEntriesHelper->getEntries('menuOfLocation', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('partOfMenu', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('dish', 'kindOfDish');
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
        ...
        $listEntries = $this->listEntriesHelper->getEntries('dish', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('event', 'kindOfEvent');
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
        ...
        $listEntries = $this->listEntriesHelper->getEntries('event', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
    ...
    {
        $listEntries = $this->listEntriesHelper->getEntries('product', 'kindOfProduct');
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
        ...
        $listEntries = $this->listEntriesHelper->getEntries('product', 'today');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
        ...
        $listEntries = $this->listEntriesHelper->getEntries('product', 'priceAdditional');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
        ...
        $listEntries = $this->listEntriesHelper->getEntries('product', 'myLocation');
        $items = [];
        foreach ($listEntries as $listEntry) {
            if (true === $listEntry['default']) {
                $items[] = $listEntry['value'];
