...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/MU/YourCityModule/Resources/public/js/MUYourCityModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                ...
                'path' => 'modules/MU/YourCityModule/Resources/scribite/TinyMce/muyourcitymodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'muyourcitymodule',
                'path' => 'modules/MU/YourCityModule/Resources/scribite/CKEditor/muyourcitymodule/',
                'file' => 'plugin.js',
