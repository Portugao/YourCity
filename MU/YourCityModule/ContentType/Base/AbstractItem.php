...
namespace MU\YourCityModule\ContentType\Base;
...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUYourCityModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single MUYourCityModule object.');
    }
    ...
    {
        $controllerHelper = $this->container->get('mu_yourcity_module.controller_helper');
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('MUYourCityModule:External:display', $this->getDisplayArguments(), ['template' => $this->customTemplate]);
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'MUYourCityModule';
