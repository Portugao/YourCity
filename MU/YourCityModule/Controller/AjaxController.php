...
use MU\YourCityModule\Controller\Base\AbstractAjaxController;
...
class AjaxController extends AbstractAjaxController
{
     ...
     *
     * @Route("/getLocationOwnerUsers", options={"expose"=true})
     * @Method("GET")
     */
    public function getLocationOwnerUsersAction(Request $request)
    {
        return parent::getLocationOwnerUsersAction($request);
    }
    
    /**
     * Retrieves a list of users.
     *
     * @Route("/getLocationAdmin1Users", options={"expose"=true})
     * @Method("GET")
     */
    public function getLocationAdmin1UsersAction(Request $request)
    {
        return parent::getLocationAdmin1UsersAction($request);
    }
    
    /**
     * Retrieves a list of users.
     *
     * @Route("/getLocationAdmin2Users", options={"expose"=true})
     * @Method("GET")
     */
    public function getLocationAdmin2UsersAction(Request $request)
    {
        return parent::getLocationAdmin2UsersAction($request);
    }
