    ...
    protected function deleteInternal(Request $request, PartOfMenuEntity $partOfMenu, $isAdmin = false)
    {
        ...
        if ($form->handleRequest($request)->isValid()) {
            if ($form->get('delete')->isClicked()) {
                ...
                $validationHooksPassed = $hookHelper->callValidationHooks($partOfMenu, 'validate_delete');
                if ($validationHooksPassed) {
                    ...
                    // Let any hooks know that we have deleted the part of menu
                    $hookHelper->callProcessHooks($partOfMenu, 'process_delete', null);
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'MUYourCityModule', 'user' => $userName, 'action' => $action, 'entity' => 'part of menu', 'id' => $itemId, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('muyourcitymodule_partOfMenu_' . /*($isAdmin ? 'admin' : '') . */'display', $urlArgs);
            }
