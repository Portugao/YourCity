...
abstract class AbstractBranchController extends AbstractController
{
     ...
     * @ParamConverter("branch", class="MUYourCityModule:BranchEntity", options = {"id" = "id", "repository_method" = "selectById"})
    ...
    protected function displayInternal(Request $request, BranchEntity $branch, $isAdmin = false)
    {
        ...
        $instanceId = $branch->createCompositeIdentifier();
    ...
    protected function deleteInternal(Request $request, BranchEntity $branch, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'branch', 'id' => $branch->createCompositeIdentifier()];
        ...
        $form = $this->createForm('MU\YourCityModule\Form\DeleteEntityType', $branch);
