    ...
    protected function deleteInternal(Request $request, ProductEntity $product, $isAdmin = false)
    {
        ...
        if ($form->handleRequest($request)->isValid()) {
            if ($form->get('delete')->isClicked()) {
                ...
                $validationHooksPassed = $hookHelper->callValidationHooks($product, 'validate_delete');
                if ($validationHooksPassed) {
                    ...
                    // Let any hooks know that we have deleted the product
                    $hookHelper->callProcessHooks($product, 'process_delete', null);
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'MUYourCityModule', 'user' => $userName, 'action' => $action, 'entity' => 'product', 'id' => $itemId, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('muyourcitymodule_product_' . /*($isAdmin ? 'admin' : '') . */'display', $urlArgs);
            }
