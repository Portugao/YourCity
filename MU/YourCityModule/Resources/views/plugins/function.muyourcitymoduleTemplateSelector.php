...
/**
 * The muyourcitymoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_muyourcitymoduleTemplateSelector($params, $view)
{
