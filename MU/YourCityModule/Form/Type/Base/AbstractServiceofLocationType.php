...
abstract class AbstractServiceofLocationType extends AbstractType
{
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('name', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            ...
            'label_attr' => [
                'class' => 'tooltips',
                'title' => $this->__('Only 100 characters.')
            ],
            'help' => $this->__('Only 100 characters.'),
            'empty_data' => '',
            'attr' => [
                'maxlength' => 100,
                'class' => '',
        ...
        $builder->add('iconForService', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            'label' => $this->__('Icon for service') . ':',
            'label_attr' => [
                'class' => 'tooltips',
    ...
    {
        return 'muyourcitymodule_serviceoflocation';
    }
