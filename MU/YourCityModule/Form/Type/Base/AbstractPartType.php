...
/**
 * Part editing form type base class.
 */
abstract class AbstractPartType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
            ...
            foreach (['imageOfPart'] as $uploadFieldName) {
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('descriptionForGoogle', TextType::class, [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the description for google of the part')
            ],
            'required' => false,
        ]);
        ...
        if ($this->variableApi->getSystemVar('multilingual') && $this->featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'part')) {
            ...
            if (is_array($supportedLanguages) && count($supportedLanguages) > 1) {
                ...
                $translatableFields = $this->translatableHelper->getTranslatableFields('part');
                $mandatoryFields = $this->translatableHelper->getMandatoryFields('part');
        ...
        $builder->add('imageOfPart', UploadType::class, [
            'label' => $this->__('Image of part') . ':',
            'attr' => [
                'class' => ' validate-upload',
                'title' => $this->__('Enter the image of part of the part')
            ],
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\YourCityModule\Entity\PartEntity',
                'empty_data' => function (FormInterface $form) {
                    return $this->entityFactory->createPart();
                },
                'error_mapping' => [
                    'imageOfPart' => 'imageOfPart.imageOfPart',
                ],
                'mode' => 'create',
                'actions' => [],
