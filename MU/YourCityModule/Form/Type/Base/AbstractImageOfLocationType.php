...
/**
 * Image of location editing form type base class.
 */
abstract class AbstractImageOfLocationType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * ImageOfLocationType constructor.
     *
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('description', TextareaType::class, [
            ...
            'attr' => [
                'maxlength' => 2000,
                'class' => '',
                'title' => $this->__('Enter the description of the image of location')
            ],
            'required' => false,
        ]);
        
        if ($this->variableApi->getSystemVar('multilingual') && $this->featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'imageOfLocation')) {
            $supportedLanguages = $this->translatableHelper->getSupportedLanguages('imageOfLocation');
            if (is_array($supportedLanguages) && count($supportedLanguages) > 1) {
                $currentLanguage = $this->translatableHelper->getCurrentLanguage();
                $translatableFields = $this->translatableHelper->getTranslatableFields('imageOfLocation');
                $mandatoryFields = $this->translatableHelper->getMandatoryFields('imageOfLocation');
        ...
        $builder->add('image', UploadType::class, [
            ...
            'attr' => [
                ...
                'title' => $this->__('Enter the image of the image of location')
            ],
        ...
        $builder->add('positionOfImage', IntegerType::class, [
            ...
            'attr' => [
                ...
                'title' => $this->__('Enter the position of image of the image of location.') . ' ' . $this->__('Only digits are allowed.')
            ],
            'required' => true,
            'scale' => 0
        ]);
    ...
    {
        return 'muyourcitymodule_imageoflocation';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\YourCityModule\Entity\ImageOfLocationEntity',
                'empty_data' => function (FormInterface $form) {
                    return $this->entityFactory->createImageOfLocation();
                },
                'error_mapping' => [
                    'image' => 'image.image',
                ],
