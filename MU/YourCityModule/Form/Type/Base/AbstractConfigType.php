...
abstract class AbstractConfigType extends AbstractType
{
    ...
    public function addGeneralSettingsFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('locationIds', TextType::class, [
                'label' => $this->__('Location ids') . ':',
                'required' => false,
                'data' => isset($this->moduleVars['locationIds']) ? $this->moduleVars['locationIds'] : '',
                'empty_data' => '',
                'attr' => [
                    'maxlength' => 255,
                    'title' => $this->__('Enter the location ids.')
                ],
            ])
            ->add('branchLocationIds', TextType::class, [
                'label' => $this->__('Branch location ids') . ':',
                'required' => false,
                'data' => isset($this->moduleVars['branchLocationIds']) ? $this->moduleVars['branchLocationIds'] : '',
                'empty_data' => '',
                'attr' => [
                    'maxlength' => 255,
                    'title' => $this->__('Enter the branch location ids.')
                ],
            ])
            ->add('partLocationIds', TextType::class, [
                'label' => $this->__('Part location ids') . ':',
                'required' => false,
                'data' => isset($this->moduleVars['partLocationIds']) ? $this->moduleVars['partLocationIds'] : '',
                'empty_data' => '',
                'attr' => [
                    'maxlength' => 255,
                    'title' => $this->__('Enter the part location ids.')
                ],
            ])
            ->add('serviceLocationIds', TextType::class, [
                'label' => $this->__('Service location ids') . ':',
                'required' => false,
                'data' => isset($this->moduleVars['serviceLocationIds']) ? $this->moduleVars['serviceLocationIds'] : '',
                'empty_data' => '',
                'attr' => [
                    'maxlength' => 255,
                    'title' => $this->__('Enter the service location ids.')
                ],
            ])
            ->add('specialLocationIds', TextType::class, [
                'label' => $this->__('Special location ids') . ':',
                'required' => false,
                'data' => isset($this->moduleVars['specialLocationIds']) ? $this->moduleVars['specialLocationIds'] : '',
                'empty_data' => '',
                'attr' => [
                    'maxlength' => 255,
                    'title' => $this->__('Enter the special location ids.')
                ],
            ])
        ;
    }
