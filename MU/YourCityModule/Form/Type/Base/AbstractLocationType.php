...
abstract class AbstractLocationType extends AbstractType
{
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('logoOfYourLocation', UploadType::class, [
            ...
            'help' => [$this->__('If your location has a logo, you can upload it here.'), $this->__f('Note: the image must have a width of at most %max% pixels.', ['%max%' => 400]), $this->__f('Note: the image must have a height of at most %max% pixels.', ['%max%' => 400]), $this->__('Note: only square dimension (no portrait or landscape) is allowed.')],
            'attr' => [
        ...
        $builder->add('owner', UserLiveSearchType::class, [
            'label' => $this->__('Owner') . ':',
            'empty_data' => '',
            'attr' => [
                'maxlength' => 11,
        ...
        $builder->add('admin1', UserLiveSearchType::class, [
        ...
        $builder->add('admin2', UserLiveSearchType::class, [
