...
/**
 * Part quick navigation form type base class.
 */
abstract class AbstractPartQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('part', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_partquicknav';
    }
}
