...
/**
 * Dish quick navigation form type base class.
 */
abstract class AbstractDishQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('partOfMenu', EntityType::class, [
    ...
    {
        $listEntries = $this->listHelper->getEntries('dish', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_dishquicknav';
    }
}
