...
/**
 * Special of location quick navigation form type base class.
 */
abstract class AbstractSpecialOfLocationQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * SpecialOfLocationQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('specialOfLocation', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_specialoflocationquicknav';
    }
}
