...
/**
 * File of location quick navigation form type base class.
 */
abstract class AbstractFileOfLocationQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * FileOfLocationQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('fileOfLocation', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_fileoflocationquicknav';
    }
}
