...
/**
 * Branch quick navigation form type base class.
 */
abstract class AbstractBranchQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * BranchQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('branch', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_branchquicknav';
    }
}
