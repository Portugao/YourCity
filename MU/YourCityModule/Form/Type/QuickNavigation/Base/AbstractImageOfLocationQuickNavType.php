...
/**
 * Image of location quick navigation form type base class.
 */
abstract class AbstractImageOfLocationQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * ImageOfLocationQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('imageOfLocation', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_imageoflocationquicknav';
    }
}
