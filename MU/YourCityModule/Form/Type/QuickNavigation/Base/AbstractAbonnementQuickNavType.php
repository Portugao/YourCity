...
/**
 * Abonnement quick navigation form type base class.
 */
abstract class AbstractAbonnementQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * AbonnementQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('abonnement', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muyourcitymodule_abonnementquicknav';
    }
}
