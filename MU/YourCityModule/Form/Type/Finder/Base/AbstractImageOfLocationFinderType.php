...
/**
 * Image of location finder form type base class.
 */
abstract class AbstractImageOfLocationFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * ImageOfLocationFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the image of location') => 1,
                $this->__('Absolute url to the image of location') => 2,
                $this->__('ID of image of location') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the image of location') => 8,
                $this->__('Image with absolute url to the image of location') => 9
            ],
    ...
    {
        return 'muyourcitymodule_imageoflocationfinder';
    }
