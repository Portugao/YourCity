...
/**
 * Dish finder form type base class.
 */
abstract class AbstractDishFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the dish') => 1,
                $this->__('Absolute url to the dish') => 2,
                $this->__('ID of dish') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the dish') => 8,
                $this->__('Image with absolute url to the dish') => 9
            ],
    ...
    {
        return 'muyourcitymodule_dishfinder';
    }
