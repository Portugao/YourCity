...
/**
 * Branch finder form type base class.
 */
abstract class AbstractBranchFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the branch') => 1,
                $this->__('Absolute url to the branch') => 2,
                $this->__('ID of branch') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the branch') => 8,
                $this->__('Image with absolute url to the branch') => 9
            ],
    ...
    {
        return 'muyourcitymodule_branchfinder';
    }
