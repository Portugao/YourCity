...
/**
 * File of location finder form type base class.
 */
abstract class AbstractFileOfLocationFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * FileOfLocationFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the file of location') => 1,
                $this->__('Absolute url to the file of location') => 2,
                $this->__('ID of file of location') => 3
            ],
        ...
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' => [
                    ...
                    $this->__('File of file') => 'fileOfFile',
    ...
    {
        return 'muyourcitymodule_fileoflocationfinder';
    }
