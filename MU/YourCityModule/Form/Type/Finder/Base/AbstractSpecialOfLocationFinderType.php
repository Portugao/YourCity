...
/**
 * Special of location finder form type base class.
 */
abstract class AbstractSpecialOfLocationFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * SpecialOfLocationFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the special of location') => 1,
                $this->__('Absolute url to the special of location') => 2,
                $this->__('ID of special of location') => 3
            ],
        ...
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' => [
                    ...
                    $this->__('Icon for special') => 'iconForSpecial',
    ...
    {
        return 'muyourcitymodule_specialoflocationfinder';
    }
