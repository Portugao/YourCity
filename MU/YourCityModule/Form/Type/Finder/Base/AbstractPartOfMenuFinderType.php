...
/**
 * Part of menu finder form type base class.
 */
abstract class AbstractPartOfMenuFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * PartOfMenuFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the part of menu') => 1,
                $this->__('Absolute url to the part of menu') => 2,
                $this->__('ID of part of menu') => 3
            ],
    ...
    {
        return 'muyourcitymodule_partofmenufinder';
    }
