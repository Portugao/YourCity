...
/**
 * Product finder form type base class.
 */
abstract class AbstractProductFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        return 'muyourcitymodule_productfinder';
    }
