...
/**
 * Part finder form type base class.
 */
abstract class AbstractPartFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the part') => 1,
                $this->__('Absolute url to the part') => 2,
                $this->__('ID of part') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the part') => 8,
                $this->__('Image with absolute url to the part') => 9
            ],
    ...
    {
        return 'muyourcitymodule_partfinder';
    }
