...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'product', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
