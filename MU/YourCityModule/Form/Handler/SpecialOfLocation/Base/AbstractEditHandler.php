...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('MU\YourCityModule\Form\Type\SpecialOfLocationType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'special of location', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
