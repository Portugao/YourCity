...
namespace MU\YourCityModule\Form\Handler\Part\Base;

use MU\YourCityModule\Form\Handler\Common\EditHandler;
use MU\YourCityModule\Form\Type\PartType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        $this->objectTypeCapital = 'Part';
        $this->objectTypeLower = 'part';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the part yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(PartType::class, $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of part area
        $codes[] = 'userIndex';
        // admin index page of part area
        $codes[] = 'adminIndex';
        // user list of parts
        $codes[] = 'userView';
        // admin list of parts
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated part
        $codes[] = 'userDisplay';
        // admin detail page of treated part
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultMessage(array $args = [], $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Part created.');
                } else {
                    $message = $this->__('Done! Part updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Part deleted.');
                break;
            default:
                $message = $this->__('Done! Part updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'part', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
