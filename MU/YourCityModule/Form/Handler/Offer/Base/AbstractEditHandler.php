...
namespace MU\YourCityModule\Form\Handler\Offer\Base;

use MU\YourCityModule\Form\Handler\Common\EditHandler;
use MU\YourCityModule\Form\Type\OfferType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'offer', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
