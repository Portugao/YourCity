...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    {
        $this->objectType = 'abonnement';
        $this->objectTypeCapital = 'Abonnement';
        $this->objectTypeLower = 'abonnement';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the abonnement yet as other items are required which must be created before!'));
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of abonnement area
        $codes[] = 'userIndex';
        // admin index page of abonnement area
        $codes[] = 'adminIndex';
        // user list of abonnements
        $codes[] = 'userView';
        // admin list of abonnements
        $codes[] = 'adminView';
        // user list of own abonnements
        $codes[] = 'userOwnView';
        // admin list of own abonnements
        $codes[] = 'adminOwnView';
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    ...
                    $message = $this->__('Done! Abonnement updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Abonnement deleted.');
                break;
            default:
                $message = $this->__('Done! Abonnement updated.');
                break;
