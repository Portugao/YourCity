 ...
 * It aims on the serviceof location object type.
 */
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the serviceof location yet as other items are required which must be created before!'));
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of serviceof location area
        $codes[] = 'userIndex';
        // admin index page of serviceof location area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated serviceof location
        $codes[] = 'userDisplay';
        // admin detail page of treated serviceof location
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            ...
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Serviceof location created.');
                } else {
                    $message = $this->__('Done! Serviceof location updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Serviceof location deleted.');
                break;
            default:
                $message = $this->__('Done! Serviceof location updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourCityModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'serviceof location', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
