...
abstract class AbstractLocationFormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents()
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'muyourcitymodule.form_aware_hook.locations.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'muyourcitymodule.form_aware_hook.locations.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'muyourcitymodule.form_aware_hook.locations.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'muyourcitymodule.form_aware_hook.locations.process_delete'
        ];
    }
}
