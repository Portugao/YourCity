...
use MU\YourCityModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('MUYourCityModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $controllerReference = new ControllerReference('MUYourCityModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUYourCityModule/Block/item_modify.html.twig';
    }
