...
abstract class AbstractCollectionFilterHelper
{
    ...
    protected function getViewQuickNavParametersForLocation($context = '', $args = [])
    {
        ...
        $parameters['owner'] = $this->request->query->getInt('owner', 0);
        $parameters['admin1'] = $this->request->query->getInt('admin1', 0);
        $parameters['admin2'] = $this->request->query->getInt('admin2', 0);
        $parameters['q'] = $this->request->query->get('q', '');
